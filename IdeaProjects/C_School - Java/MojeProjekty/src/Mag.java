public class Mag implements IOtrzymaneObrazenia{
    ...
    private static EWspolczynikZdrowia wspolczynikObrazen = EWspolczynikZdrowia.MAG;

    public Mag(String imie, int obrazenia, int predkosc) {
        this.imie = imie;
    ...
    public int otrzymaneObrazenia(int iloscJednostek) {
        stanZdrowia2 -= (wspolczynikObrazen.getWspolczynik()*iloscJednostek);
        return stanZdrowia2;
    }
